...
export default function GCOQuestionSection() {
  ...
  const cards = [
    {
      icon: (
        <svg width="46" height="46" viewBox="0 0 24 24" fill="none" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: "15px" }} aria-hidden="true">
          {/* Scales of Justice */}
          <path d="M12 3v18" />
          <path d="M9 21h6" />
          <path d="M5 7v1" />
