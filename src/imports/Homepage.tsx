...
function GlobalAlignedContent() {
  ...
  <div className="flex flex-row gap-4 items-end w-full">
    {/* Image 9 - Using object-contain to show the full image */}
    <div className="w-1/2" data-name="image 9">
      <img 
        alt="" 
    ...
    {/* Image 7 - Using object-contain to show the full image */}
    <div className="w-1/2" data-name="image 7">
      <img 
        alt="" 
        className="w-full h-auto rounded-2xl object-contain" 
        src={imgImage7} 
